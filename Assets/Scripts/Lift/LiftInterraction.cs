...
public class LiftInterraction : Interactable
{
    ...
    void Start()
    {
        ...
        floor1 = GameObject.FindWithTag("F1L").transform.position;
        floor2 = GameObject.FindWithTag("F2L").transform.position;
        floor3 = GameObject.FindWithTag("F3L").transform.position;
